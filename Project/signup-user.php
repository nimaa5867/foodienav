  ...
  <div class="container-forms">
    <form action="signup-user.php" method="POST" autocomplete="">
      ...
      <div class="form-group">
        <input class="text-space" type="text" name="f_name" placeholder="First Name" required value="<?php echo $fname ?? ''; ?>">
        <input class="text-space" type="text" name="l_name" placeholder="Last Name" required value="<?php echo $lname ?? ''; ?>">
        <input class="text-space" type="email" name="user_email" placeholder="Email Address" required value="<?php echo $email ?? ''; ?>">
        <input class="text-space" type="password" name="user_password" placeholder="Password" required>
